...
class DetectorDataset(Dataset):
    def __init__(self, data_dir, patient_ids, config, phase='train'):
...
class DataDetectorTestDataset(Dataset):
    def __init__(self, data_dir, patient_ids, config, split_comber=None):
        self.stride = config['stride']  # 4
        self.pad_value = config['pad_value']
